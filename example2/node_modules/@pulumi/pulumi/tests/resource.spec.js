...
describe("createUrn", () => {
    ...
    it("handles name and type", () => __awaiter(void 0, void 0, void 0, function* () {
        const urn = yield resource_1.createUrn("n", "t").promise();
        assert.strictEqual(urn, "urn:pulumi:mystack::myproject::t::n");
    }));
    it("handles name and type and parent", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("handles name and type and parent with parent", () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("allAliases", () => {
    ...
    for (const testCase of testCases) {
        it(testCase.name, () => __awaiter(void 0, void 0, void 0, function* () {
...
describe("ComponentResource", () => {
    ...
    it("propagates provider to children", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // https://github.com/pulumi/pulumi/issues/12161
    it("propagates providers list to children", () => __awaiter(void 0, void 0, void 0, function* () {
        const provider = new MyProvider("prov");
...
class MyProvider extends resource_1.ProviderResource {
    constructor(name) {
        super("test", name);
    }
}
class MyCustomResource extends resource_1.CustomResource {
    constructor(name, opts) {
...
describe("parent and dependsOn are the same 12032", () => {
    ...
    // https://github.com/pulumi/pulumi/issues/12161
    it("runs without error", () => __awaiter(void 0, void 0, void 0, function* () {
        const parent = new resource_1.ComponentResource("pkg:index:first", "first");
        const child = new resource_1.ComponentResource("pkg:index:second", "second", {}, {
            parent,
            dependsOn: parent,
        });
