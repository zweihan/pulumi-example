 ...
 */
export declare class RegistryIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryIamMemberState, opts?: pulumi.CustomResourceOptions): RegistryIamMember;
    /**
     * Returns true if the given object is an instance of RegistryIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryIamMember;
    readonly condition: pulumi.Output<outputs.iot.RegistryIamMemberCondition | undefined>;
    /**
