 ...
 */
export declare class RegistryIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryIamBindingState, opts?: pulumi.CustomResourceOptions): RegistryIamBinding;
    /**
     * Returns true if the given object is an instance of RegistryIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryIamBinding;
    readonly condition: pulumi.Output<outputs.iot.RegistryIamBindingCondition | undefined>;
    /**
