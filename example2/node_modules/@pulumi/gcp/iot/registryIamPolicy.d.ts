 ...
 */
export declare class RegistryIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryIamPolicyState, opts?: pulumi.CustomResourceOptions): RegistryIamPolicy;
    /**
     * Returns true if the given object is an instance of RegistryIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegistryIamPolicy;
    /**
