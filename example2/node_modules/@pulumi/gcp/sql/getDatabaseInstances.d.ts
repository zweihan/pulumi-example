 ...
 * ```
 */
export declare function getDatabaseInstancesOutput(args?: GetDatabaseInstancesOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDatabaseInstancesResult>;
/**
 * A collection of arguments for invoking getDatabaseInstances.
 */
