 ...
 * ```
 */
export declare function getAttachedInstallManifestOutput(args: GetAttachedInstallManifestOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetAttachedInstallManifestResult>;
/**
 * A collection of arguments for invoking getAttachedInstallManifest.
 */
