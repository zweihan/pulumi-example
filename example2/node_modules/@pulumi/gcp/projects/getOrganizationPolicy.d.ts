 ...
 * ```
 */
export declare function getOrganizationPolicyOutput(args: GetOrganizationPolicyOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetOrganizationPolicyResult>;
/**
 * A collection of arguments for invoking getOrganizationPolicy.
 */
